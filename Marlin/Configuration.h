...
//#define DEFAULT_AXIS_STEPS_PER_UNIT     { 80, 80, 400, 140 } // Stock Creality CR10S V2
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -11, -2.7 } // MicroSwiss NG
